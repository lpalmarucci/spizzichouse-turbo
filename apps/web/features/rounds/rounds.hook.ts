...
import { CREATE_ROUND, DELETE_ROUND, GET_ROUNDS, ROUNDS_QUERY_KEY } from '@/features/rounds/rounds.query';
...
export const useDeleteRound = () =>
  useMutation({
    ...
    mutationFn: (id: string) => gqlRequest<{ round: Round }>(DELETE_ROUND, { id }),
  });
